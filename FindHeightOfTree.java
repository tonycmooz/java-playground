 ...
 * This Java class, FindHeightOfTree, has my own inserts  
 * for my own testing and knowledge pursuits
 */
...
public class FindHeightOfTree {
    ...
    public static void main(String[] args) {
        ...
        // // Test Inserts for Tree 1
        // Node tree = new Node(99);
        // tree.insert(3);
        // tree.insert(7);
        // tree.insert(1);
        // tree.insert(-1);
