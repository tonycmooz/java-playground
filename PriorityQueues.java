...
public class PriorityQueues{
	...
	public static void main(String args[]){
		PriorityQueue myQueue = new PriorityQueue(8);
		myQueue.insert(10);
		myQueue.insert(2);
		myQueue.insert(4);
		myQueue.insert(9);
		...
		myQueue.insert(3);
		myQueue.insert(37);
		// Higher numbers have higher priority, so they are on the top

		// System.out.print("Peek at the front of the Queue: " + myQueue.peek());

		// System.out.print("Size of Priority Queue: " + myQueue.getSize());

		for(int i = 7; i>=0; i--)
			System.out.print(myQueue.remove() + " "); // will print the queue in reverse order
